...
const updateCommentTopicOrientationController = async (req, res) => {
  const { topicId, commentId } = req.params;
  const { message } = req.body;

  try {
    const result = await topicsOrientationModel.findOneAndUpdate(
...
export default updateCommentTopicOrientationController;