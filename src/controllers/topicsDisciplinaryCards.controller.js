...
const topicsDisciplinaryCardsController = async (req, res) => {
  try {
    // Agregar logs para depuración
    console.log("📌 Conectando a MongoDB y buscando datos...");

    const topics = await topicsDisciplinaryModel.find().select("title description image");
...
export default topicsDisciplinaryCardsController;
